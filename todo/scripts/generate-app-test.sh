...
cp -f -p -r ./common-test/java/selenium ./target-project/todo/src/test/java/todo
# mybatis3
...
cp -f -p -r ./common-test/java/selenium ./target-project/todo-mybatis3/src/test/java/todo
# mybatis3-multi
...
cp -f -p -r ./common-test/java/selenium ./target-project/todo-mybatis3-multi/todo-mybatis3-multi-selenium/src/test/java/todo
# jpa
...
cp -f -p -r ./common-test/java/selenium ./target-project/todo-jpa/src/test/java/todo
# jpa-multi
...
cp -f -p -r ./common-test/java/selenium ./target-project/todo-jpa-multi/todo-jpa-multi-selenium/src/test/java/todo
