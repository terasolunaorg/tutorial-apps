...
public class TodoTest {
	...
	public void testList() throws IOException {
		...
		assertThat(webDriver.findElement(By.xpath("/html/body/h1")).getText()
	...
	public void testCreate() throws IOException {
		...
		webDriver
				.findElement(
						By.xpath("//form[@action='/todo-mybatis3/todo/create']/button"))
				.click();
		...
		todoList_ul_li
				.findElement(
						By.xpath("//form[@action='/todo-mybatis3/todo/delete']/button"))
				.click();
	}
	...
	public void testFinish() throws IOException {
		...
		webDriver
				.findElement(
						By.xpath("//div[@id='todoList']/ul/li/form[@action='/todo-mybatis3/todo/finish']/button"))
				.click();
	...
	public void testDelete() throws IOException {
		...
		webDriver
				.findElement(
						By.xpath("//div[@id='todoList']/ul/li/form[@action='/todo-mybatis3/todo/delete']/button"))
				.click();
