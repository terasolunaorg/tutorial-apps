...
public class TodoTest {
	...
	public void testCreate() throws IOException {
		...
		webDriver
				.findElement(
						By.xpath("//form[@action='/todo-jpa-multi-web/todo/create']/button"))
				.click();
		...
		todoList_ul_li
				.findElement(
						By.xpath("//form[@action='/todo-jpa-multi-web/todo/delete']/button"))
				.click();
	}
	...
	public void testFinish() throws IOException {
		...
		webDriver
				.findElement(
						By.xpath("//div[@id='todoList']/ul/li/form[@action='/todo-jpa-multi-web/todo/finish']/button"))
				.click();
	...
	public void testDelete() throws IOException {
		...
		webDriver
				.findElement(
						By.xpath("//div[@id='todoList']/ul/li/form[@action='/todo-jpa-multi-web/todo/delete']/button"))
				.click();
