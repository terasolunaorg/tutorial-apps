...
public class TodoTest {
	...
	public void testCreate() throws IOException {
		...
		webDriver
				.findElement(
						By.xpath("//*[@id='todoList']/ul/li/form[@action='/todo-jpa-multi-web/todo/delete']/button"))
				.click();
	}
	...
	public void testFinish() throws IOException {
		...
		webDriver
				.findElement(
						By.xpath("//*[@id='todoList']/ul/li/form[@action='/todo-jpa-multi-web/todo/finish']/button"))
				.click();
