...
<body>
	...
	<div class="container">
		...
		<form:form action="${pageContext.request.contextPath}/account/create"
			method="get" modelAttribute="accountCreateForm">
			...
			<table>
				...
				<tr>
					...
					<td><form:password path="password" cssErrorClass="error-input" />
						<form:errors path="password" cssClass="error-messages" /></td>
				</tr>
				<tr>
					<td><form:label path="confirmPassword"
							cssErrorClass="error-label">password (confirm)</form:label></td>
					<td><form:password path="confirmPassword"
							cssErrorClass="error-input" /> <form:errors
							path="confirmPassword" cssClass="error-messages" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><form:input path="address"
							value="${f:h(accountCreateForm.address)}"
