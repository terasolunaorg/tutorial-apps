...
public class TodoApiTest {
	...
	public void setUp() throws Exception {
		...
		List<String> todoIds = given()
				.when()
				.get("http://localhost:8080/todo-api-jpa-multi-web/api/v1/todos")
				.then().extract().jsonPath().getList("todoId");

		// Delete all existing todos
		for (String todoId : todoIds) {
			given().when()
					.delete("http://localhost:8080/todo-api-jpa-multi-web/api/v1/todos/{todoId}",
							todoId);
		}
	}
	...
	public void testCreateErr400() throws Exception {
		...
		given().body(jsonBody)
				...
				.when()
				.post("http://localhost:8080/todo-api-jpa-multi-web/api/v1/todos")
				.then()
				.statusCode(400)
	...
	public void testGetOneErr404() throws Exception {
		...
		// getting request
		given().when()
				.get("http://localhost:8080/todo-api-jpa-multi-web/api/v1/todos/{todoId}Nonexist",
						todoId)
				.then()
				.statusCode(404)
	...
	public void testGetOne() throws Exception {
		...
		// getting request
		given().when()
				.get("http://localhost:8080/todo-api-jpa-multi-web/api/v1/todos/{todoId}",
	...
	public void testPutErr405() throws Exception {
		...
		given().body(jsonBody)
				.contentType(ContentType.JSON)
				.when()
				.put("http://localhost:8080/todo-api-jpa-multi-web/api/v1/todos")
				.then()
				.statusCode(405)
	...
	public void testPutErr409() throws Exception {
		...
		given().body(jsonBody)
				.contentType(ContentType.JSON)
				.when()
				.put("http://localhost:8080/todo-api-jpa-multi-web/api/v1/todos/{todoId}",
						todoId);
